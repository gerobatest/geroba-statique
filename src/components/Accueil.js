            ...
            <div className="sectionText">
              ...
              <div>
                  ...
                  <p className="paragraph">
                    ...
                    <b>une version pour les gestionnaires sur PC pour analyser le patrimoine
                  ...
                  <p className="paragraph">
                    La solution est aussi bien destinée aux maîtres d'ouvrage,
                     aux maître d'œuvres ainsi qu’aux entreprises.
                  </p>
              </div> 
            </div>
          </div>
