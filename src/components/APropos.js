            ...
            <div className="sectionText">
                ...
                <div>
                    <p className="paragraph">
                      Il s’agit d’une solution Fullweb qui offre la possibilité d'une version
                    ...
                    <p className="paragraph">
                      Dans le domaine routier, le fonctionnement se fait en <b>PR + Abs</b>
                      et bien entendu en coordonnées  (x ; y) ; pour le bâtiment le 
